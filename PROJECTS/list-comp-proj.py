...
countries.sort() # sort the country in accending order 
length_of_countries = [ len(c) for c in countries] # character length of each country

max_country = [x for x in countries if len(x) == max(length_of_countries)] # maximum length of the list of each country
min_country = [x for x in countries if len(x) == min(length_of_countries)] # maximum length of the list of each country
